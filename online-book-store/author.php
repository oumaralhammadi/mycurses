...
$id = $_GET['id'];
include "./init.php";
$books      = get_book_by_author($con,$id);
$authers    = get_all_authers($con);
$caregoreis = get_all_caregory($con);
$current_authers = get_authers($con,$id);
...
?>
    ...
    <head>
        ...
        <title><?=$current_authers['name']?></title>
        <!-- bootstrap CSS 5 CDN -->
    ...
    <div class="container">
        ...
        <div class="container"> 
            <h1 class="display-4 p-3 fs-3"><?=$current_authers['name']?></h1>
            <div class="d-flex">
                <?php if($books == 0){ ?>
                    <div class="alert alert-warning text-center p-5 mt-3 me-2" style="width: 100%;" role="alert">
